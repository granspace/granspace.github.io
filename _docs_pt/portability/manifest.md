...
description: Mova sua configuração do devhub entre máquinas com um manifesto.
---
...
**⋯ → Exportar manifesto** baixa um `devhub.manifest.json` descrevendo seus
projetos acompanhados (caminhos, remotes git e metadados). Secrets **não** são
incluídos.

## Importar

**⋯ → Importar manifesto** lê um manifesto e adiciona os projetos dele. O devhub
...
- Configurar o devhub numa máquina nova.
