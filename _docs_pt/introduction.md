...
description: O que é o devhub — um gerenciador local dos projetos de desenvolvimento espalhados pela sua máquina.
---

O **devhub** é um gerenciador local dos projetos de desenvolvimento espalhados
...
O devhub é um app com três superfícies, todas apoiadas na mesma lógica. **Hoje
...
<figure class="shot">
  <img src="{{ '/images/intro-overview.png' | relative_url }}" alt="Visão geral do painel do devhub" loading="lazy" />
...
O devhub escuta apenas em loopback e guarda tudo num banco SQLite local na sua
máquina. Nada é enviado para lugar nenhum. Veja [Local por design]({{ '/pt-br/docs/security/local-only/' | relative_url }}).

## Próximos passos

- [Instalar o devhub]({{ '/pt-br/docs/getting-started/installation/' | relative_url }})
