...
section: Portability
description: Move your devhub setup between machines with a manifest.
---
...
**⋯ → Export manifest** downloads a `devhub.manifest.json` describing your tracked
projects (paths, git remotes and metadata). Secrets are **not** included.

## Import

**⋯ → Import manifest** reads a manifest and adds its projects. devhub asks
...
- Set up devhub on a new machine.
