...
title: Overview
section: Extensions
description: How devhub detects project types and discovers commands — declaratively, via extensions.
---

Extensions add support for more languages and tools **without changing devhub
...
devhub ships with built-ins for **Node**, **Docker Compose**, **Unity**,
...
and *where commands come from* (e.g. the `scripts` in a `package.json`). devhub
